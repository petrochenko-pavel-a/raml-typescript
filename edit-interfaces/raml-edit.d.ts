import ASTBasics=module("ast.ts")

declare type StringLiteral = ASTBasics.StringLiteral
declare type NumberLiteral = ASTBasics.StringLiteral
declare type SourceNode=ASTBasics.SourceNode

/**
 *
 */ 
declare type MarkdownString = StringLiteral

/**
 * One of HTTP, HTTPS
 */
declare type Protocol = StringLiteral
 ...
 * 
 */
declare type MediaType = StringLiteral



declare type SchemaDefinition = StringLiteral

/**
 * Regular expressions MUST follow the regular expression specification from ECMA 262/Perl 5.
 */
declare type RegexPattern = StringLiteral

/**
 * A valid HTTP method name in lowercase ( "put", "get", ... )
 */
declare type HTTPMethodName = StringLiteral
 ...
 */
declare type SecuritySchemeType = StringLiteral



interface ApiNode extends SourceNode{
     ...
     * The property's value MAY be a single StringLiteral with a valid media type
     *
     ...
     */
    schemas?:                {[ schemaName: StringLiteral ]: SchemaDefinition }[]
     ...
     */
    resourceTypes?:          {[ resourceTypeName: StringLiteral ]: ResourceType }[]

    securitySchemes?:        {[ securitySchemeName: StringLiteral ]: SecurityScheme }[]

    traits?:                 {[ traitName: StringLiteral ]: Trait }[]

    securedBy?:              StringLiteral[]
}

interface ResourceASTNode extends SourceNode{


    relativeUri:             StringLiteral
    relativeUriPathSegments: StringLiteral[]// required?
    ...
    type?:                   StringLiteral | ResourceType
 ...
 * @see http://raml.org/spec.html#methods
 */
interface MethodASTNode extends SourceNode{
    /**
     ...
     *
     * If the resource or its method supports a query StringLiteral, the query StringLiteral
...
interface ResourceTypeASTNode extends SourceNode{
 ...
 * @see http://raml.org/spec.html#user-documentation
 */
interface DocumentationItemASTNode extends SourceNode{
    title:                   StringLiteral
 ...
 * @see http://raml.org/spec.html#responses
 */
interface ResponseASTNode extends SourceNode {
    /**
 ...
 */
interface SecuritySchemeASTNode extends SourceNode{
    type?:            SecuritySchemeType
    description?:     MarkdownString
    settings?:        { [ settingName: StringLiteral ]: StringLiteral }
    describedBy?:     SecuritySchemeDescription
}

interface SecuritySchemeDescriptionASTNode extends SourceNode{
    uriParameters?:   NamedParameterMap
    headers?:         NamedParameterMap
    responses?:       Responses
}
...
// TODO
interface TraitASTNode extends SourceNode{
    description?:     MarkdownString
}

interface BodiesASTNode extends SourceNode{
    "application/x-www-form-urlencoded"?: WebFormBodyPayload;
    "multipart/form-data"?:               WebFormBodyPayload;
    [ mediaType: StringLiteral ]:                BodyPayload
}

interface BodyPayloadASTNode extends SourceNode{
    /**
     ...
     */
    schema?:          StringLiteral | SchemaDefinition
 ...
 */
interface WebFormBodyPayloadASTNode extends SourceNode{
...
interface Responses { [ statusCode: StringLiteral ]: Response } // [statusCode:StringLiteral]:  Response | Null


interface NamedParameterMap { [ parameterName: StringLiteral ]: NamedParameter | NamedParameter[] }

/**
 * @see http://raml.org/spec.html#named-parameters
 */
interface BasicNamedParameterASTNode extends SourceNode{
    ...
    /**
     * (Optional, applicable only for parameters of type StringLiteral)
    ...
    // TODO: types should be a StringLiteral enum. They are not supported by Typescript at the moment
    /**
     ...
     * If type is not specified, it defaults to StringLiteral.
     *
...
interface NumericNamedParameterASTNode extends BasicNamedParameter {
    // TODO: verify on JS parser output
    /**
     * (Optional, applicable only for parameters of type NumberLiteral or integer)
     * The minimum attribute specifies the parameter's minimum value.
     *
     * @see http://raml.org/spec.html#minimum
     */
    minimum?:         NumberLiteral
     ...
     */
    maximum?:         NumberLiteral
}

interface StringNamedParameterASTNode extends BasicNamedParameter {

    // TODO: verify on JS parser output
    /**
     * (Optional, applicable only for parameters of type StringLiteral)
     *
     * The pattern attribute is a regular expression that a parameter of type StringLiteral MUST match.
    ...
    /**
     * (Optional, applicable only for parameters of type StringLiteral)
     * The minLength attribute specifies the parameter value's minimum NumberLiteral of characters.
     *
     * @see http://raml.org/spec.html#minlength
     */
    minLength?:       NumberLiteral

    // TODO: verify on JS parser output
    /**
     * (Optional, applicable only for parameters of type StringLiteral)
     * The maxLength attribute specifies the parameter value's maximum NumberLiteral of characters.
     *
     * @see http://raml.org/spec.html#maxlength
     */
    maxLength?:       NumberLiteral

}

declare type NamedParameterASTNode = BasicNamedParameterASTNode | NumericNamedParameterASTNode | StringNamedParameterASTNode